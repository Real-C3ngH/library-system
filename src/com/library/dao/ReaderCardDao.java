...
public class ReaderCardDao {
    ...
    public int getIdMatchCount(final String username, final String password) {
    ...
    public ReaderCard findReaderByReaderId(final String  username) {
        return sqlSessionTemplate.selectOne(NAMESPACE + "findReaderByReaderId", username);
    }
